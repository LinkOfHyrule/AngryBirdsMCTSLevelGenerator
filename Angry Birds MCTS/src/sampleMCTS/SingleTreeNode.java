...
public class SingleTreeNode
{
    ...
    private Agent agent;
    public SingleTreeNode(Random rnd, Agent agent) {
        this(null, null, rnd, agent);
    }

    public SingleTreeNode(StateObservation state, SingleTreeNode parent, Random rnd, Agent agent) {
        this.state = state;
        this.parent = parent;
        this.m_rnd = rnd;
        this.agent = agent;
    ...
    public int mctsSearch(ElapsedCpuTimer elapsedTimer) {
        ...
        while(remaining > 2*avgTimeTaken && remaining > remainingLimit){
            ...
            // Don't count the rollout towards the timeout.
    ...
    public SingleTreeNode expand() {
        ...
        nextState.advance(agent.actions[bestAction], false /*takingBestAction*/);

        SingleTreeNode tn = new SingleTreeNode(nextState, this, this.m_rnd, agent);
    ...
    public double rollOut()
    {
        ...
        while (!finishRollout(rollerState,thisDepth)) {
            ...
            rollerState.advance(agent.actions[action], false /*takingBestAction*/);
            thisDepth++;
        }
