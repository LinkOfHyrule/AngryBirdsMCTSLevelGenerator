...
public class DLTrajectory
{
    ...
    public ActionRobot actionRobot = null;
	...
	*/
	public DLTrajectory(ActionRobot tmpActionRobot, TrajectoryPlanner tmpTp, Rectangle tmpSling, ABType tmpBirdOnSling, Point tmpReleasePoint, Point tmpTargetPoint, ABObject tmpTargetObject,List<ABObject> tmpHills, List<ABObject> tmpBlocks, List<ABObject> tmpPigs)
	{
