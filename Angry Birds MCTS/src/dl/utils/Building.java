...
public class Building
{
	...
	*/
	private DLTrajectory isReachable(ActionRobot _actionRobot, TrajectoryPlanner _tp,Rectangle _sling, ABType _birdOnSling, List<ABObject> _hills, List<ABObject> _blocks, List<ABObject> _pigs, Point targetPoint, ABObject targetObject)
	{
	...
	*/
	private DLTrajectory getShotForJoint(ActionRobot _actionRobot, TrajectoryPlanner _tp,Rectangle _sling, ABType _birdOnSling, List<ABObject> _hills, List<ABObject> _blocks, List<ABObject> _pigs, ABObject bl)
	{
	...
	*/
	public List<DLTrajectory> findJoints(ActionRobot _actionRobot, TrajectoryPlanner _tp,Rectangle _sling, ABType _birdOnSling, List<ABObject> _hills, List<ABObject> _blocks, List<ABObject> _pigs, boolean spare)
	{	
